...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="./Medecin_dashboard.php" class="nav-link active" aria-current="page">
    ...
    try {
        ...
        if($statement->rowCount() > 0) {
            ...
            while($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                ...
                // Formulaire caché avec l'ID du rendez-vous
echo "<form action='./actions/envoyer_email.php' method='post'>";
echo "<input type='hidden' name='id_rendezvous' value='" . $row['id_rendezvous'] . "'>";
echo "<td>
        <div class=\"d-inline-flex\">
            <button type=\"submit\" name=\"accepter\" class=\"btn btn-success me-1\">Accepter</button>
